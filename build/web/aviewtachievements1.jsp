<%-- 
    Document   : aviewtachievements1
    Created on : 13 May, 2020, 3:03:53 AM
 ...
 <h1 style="color:#990000;font-size:30px;"><b>Teacher Achievements</b></h1>
    ...
    <center>
      ...
      <%}%>
        ...
        <br><br>
  <a href="aviewtachievements.jsp" style="border-radius:10%;padding:15px;font-size:18px;border:none;text-decoration:none;background:#333333;color:white;">Back</a>
    </center><br><br><br><br>
    </center>
    </body>
</html>
