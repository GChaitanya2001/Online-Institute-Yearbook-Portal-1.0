<%-- 
    Document   : uviewtachievements1
    Created on : 12 May, 2020, 3:13:45 PM
...
<%
   ...
   String sql="select * from achievements where year='"+year+"' and department='"+dept+"' and utype='teacher'";
   Statement st=conn.createStatement();
   ResultSet rs=st.executeQuery(sql);
%>

 <h1 style="color:#990000;font-size:30px;"><b>Teacher Achievements</b></h1>
    <center>
    ...
    <center>
      ...
      <%}%>
        ...
        <br><br>
  <a href="uviewtachievements.jsp" style="border-radius:10%;padding:15px;font-size:18px;border:none;text-decoration:none;background:#333333;color:white;">Back</a>
    </center><br><br><br><br>
    </center>
    </body>
</html>
