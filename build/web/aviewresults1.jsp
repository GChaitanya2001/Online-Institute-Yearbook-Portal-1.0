<%-- 
    Document   : aviewresults1
    Created on : 18 May, 2020, 1:55:13 AM
...
%>               
    ...
    <div style="width:50%;float:right;height:600px;">
        <div style="width:80%;background:pink;border-radius:10%;">
...
%>               
    ...
    <div style="width:50%;float:right;height:550px;overflow-y:auto;">
        <h1 style="font-size:30px;color:#990000;"><b>Round 2 Results</b></h1><br> 
