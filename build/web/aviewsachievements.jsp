<%-- 
    Document   : aviewsachievements
    Created on : 13 May, 2020, 2:56:45 AM
...
<html>
    ...
    <center>
     ...
     <div class="loginbox" style="top:350px;height:400px">
         ...
         <h1 style="color:#990000;"><b>Student Achievements</b></h1>
         <form action="aviewsachievements1.jsp" method="post">
             <p>Select Year</p>
