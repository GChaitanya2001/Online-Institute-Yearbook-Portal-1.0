<%-- 
    Document   : escoreviewachieve
    Created on : 16 May, 2020, 7:48:17 PM
...
%>
       ...
       <center><a href="escorenominees1.jsp?award=<%=award%>&utype=<%=utype%>" style="font-size:20px;border-radius:5px;padding:15px;text-decoration:none;border:none;background:#444;color:#fff;">Back</a></center>
  </body>
</html>
