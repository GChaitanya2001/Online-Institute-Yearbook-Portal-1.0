<%-- 
    Document   : eshortviewachieve
    Created on : 16 May, 2020, 5:39:50 PM
...
<%@page session="true"%>
    ...
    <center><h1 style="font-size:30px;color:#990000;background:#e2e220;width:20%;border-radius:30px;"><b>View Achievements</b></h1></center><br><br>
...
%>
       ...
       <center><a href="eshortlistnominees1.jsp?award=<%=award%>&utype=<%=utype%>" style="font-size:20px;border-radius:5px;padding:15px;text-decoration:none;border:none;background:#444;color:#fff;">Back</a></center>
  </body>
</html>
